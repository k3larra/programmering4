...
public class Parser {
	 ...
	 *         a number of central stations like Malm� Copenhagen etc
	 */
	...
	/**
	 * Calls Sk�netrafiken API and searches for departures from a certain
	 ...
	 * selPointFr=malm�%20C|80000|0&selPointTo=landskrona|82000|0&LastStart=
			...
			for (int i = 0; i < nl.getLength(); i++) {
				...
				for (int j = 0; j < lineNode.getLength(); j++) {
					...
					if (j == 0) {
						...
						// along the journey between startStation and endStation
					}
				}
	...
	/**
	 * Calls Sk�netrafiken API and searches for nest departures from a certain
	 * station returns all lines leaving that station Use this Url to test from
	 * a browser from ub�tshallen:
